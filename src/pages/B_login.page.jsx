    ...
    <div className="flex min-h-screen bg-gray-100 items-center justify-center p-4 sm:p-6">
      <div className="w-full sm:max-w-md md:max-w-lg lg:max-w-xl bg-white rounded-2xl shadow-xl p-8 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <h3 className="text-2xl font-bold text-blue-500">Buyer's Login</h3>
          <p className="text-sm text-gray-500">
            Sign in to access fresh local produce and manage your orders.
          </p>
        </div>
        {/* Login form */}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
            ...
            className={`w-full py-3 font-semibold rounded-lg shadow-md transition-all duration-300
                 ${
                   !username || !password
                     ...
                     : "bg-gradient-to-r from-blue-400 to-blue-500 text-white hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                 }`}
          >
        ...
        <div className="p-4 border-2 border-blue-200 bg-blue-50 rounded-lg space-y-2">
          ...
          <p className="text-sm text-blue-500">
            Browse fresh local produce, manage your cart, and connect directly
            with farmers.
          </p>
        </div>
      </div>
