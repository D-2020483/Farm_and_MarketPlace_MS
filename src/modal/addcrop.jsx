  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-emerald-500 text-white rounded-lg px-4 py-2 sm:px-5 sm:py-2.5 hover:bg-emerald-600 transition-colors duration-200 shadow-sm">
      ...
      <DialogContent className="max-w-lg w-[95%] sm:w-[80%] md:w-[600px] bg-white shadow-sm rounded-lg border-0">
        <DialogHeader className="hidden sm:block">
          <DialogTitle className="text-emerald-500">Add New Crop</DialogTitle>
          <DialogDescription>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col">
              ...
              >
                <SelectTrigger className="w-full bg-white pl-10 pr-4 py-2 border border-gray-300 text-gray-700 rounded-md shadow-sm focus:ring-2 focus:ring-emerald-400 focus:outline-none">
